...
<html class="no-js" lang="zxx">
	...
	if(donnees[0].lang=="fr"){ 
  	...
  	contenuHtml1+='</a></div>';
           ...
           contenuHtml+='</div>';
           document.getElementById("subrech").options[0].text = subject;
           document.getElementById("genderrech").options[0].text = gender;
      	 document.getElementById("locrech").options[0].text = location;
      	 document.getElementById("lanrech").options[0].text = language;
